...
import CopyBlank from "../pages/panel/copywriter/_Blank";
import CopyDashboard from "../pages/panel/copywriter/Index";
import CopyDocumentDrafts from "../pages/panel/copywriter/DocumentDrafts";
...
import CopyTemplates from "../pages/panel/copywriter/Templates";
      ...
      <Routes>
        ...
        <Route path="demo9" element={<LayoutCopywriter />}>
          <Route path="copywriter">
            ...
            <Route path="pricing-plans" element={<CopyPricingPlans />}></Route>
