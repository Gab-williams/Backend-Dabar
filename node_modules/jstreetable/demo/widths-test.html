	...
	<head>
		...
		$(document).ready(function(){
				...
				for (i=0; i<trees.length; i++) {
					expected = trees[i].table.width+': '+[trees[i].table.columns[0].width,trees[i].table.columns[1].width,trees[i].table.columns[2].width].join(' ');
					...
					$("div#jstree"+i).on("loaded_table.jstree",function(){
						var wrapper = $(this).closest("div.jstree-table-wrapper"),
						midw = wrapper.children("div.jstree-table-midwrapper"),
						section = wrapper.closest("div.treesection"),
						actuals = "Actuals "+wrapper.outerWidth()+": "+[midw.find("div.jstree-table-column:eq(0)").outerWidth(),midw.find("div.jstree-table-column:eq(1)").outerWidth(),midw.find("div.jstree-table-column:eq(2)").outerWidth()].join(' ');
